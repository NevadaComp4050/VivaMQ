...
export default function VivaManagement() {
  ...
  const [students, setStudents] = useState<Student[]>([
    ...
    },
    {
      ...
      name: "Jane Smith",
      assignmentId: "assignment1",
      submissionText: "Jane's submission on database normalization...",
      questions: [
        {
          id: 1,
          text: "What are the advantages of using the BCNF?",
          status: "Locked",
        },
        {
          id: 2,
          text: "Explain the concept of functional dependencies.",
          status: "Unlocked",
        },
      ],
    },
    {
      ...
      submissionText: "Alice's submission on SQL queries...",
      questions: [
        {
          id: 1,
    ...
    },
    {
      ...
      submissionText: "Bob's submission on design patterns...",
      questions: [
        {
          id: 1,
          text: "Describe the Singleton design pattern and its use cases.",
          status: "Locked",
        },
        {
          id: 2,
          text: "Compare and contrast the Factory and Abstract Factory patterns.",
          status: "Unlocked",
        },
      ],
    },
  ...
  useEffect(() => {
    if (selectedUnit) {
      const filtered = assignments.filter(
        (assignment) => assignment.unitId === selectedUnit
      );
  ...
  useEffect(() => {
    if (selectedAssignment) {
      const filtered = students.filter(
        (student) => student.assignmentId === selectedAssignment
      );
  ...
  const handleLockQuestion = (studentId: number, questionId: number) => {
    setStudents(
          ...
          ? {
              ...
              questions: student.questions.map((q) =>
                q.id === questionId
                  ? {
                      ...q,
                      status: q.status === "Locked" ? "Unlocked" : "Locked",
                    }
                  : q
              ),
            }
  ...
  const handleRegenerateQuestion = (studentId: number, questionId: number) => {
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="submission-upload">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Note: Question generation can take up to 24 hours.
                </p>
              </div>
            </CardContent>
          </Card>
